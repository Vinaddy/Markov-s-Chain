train_data = open('test_text.txt','r')
...
def get_next_probability(given_list):   #returns dictionary
    ...
    #value is a number which shows the number of times a key occurs
    #diving the value by total number of items in the list gives us 
    #the probability of that key
